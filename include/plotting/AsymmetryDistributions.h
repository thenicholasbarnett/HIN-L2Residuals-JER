...
inline void DrawTruncLines( TH1D* h, double fraction, Color_t col,
...
inline void DrawAsymBase( TH1D* hData, TH1D* hMC,
...
inline void PlotAsymDist( TFile* fIn, const TString& outDir,
