...
// (5.36 TeV)") -- see the comments at that exact spot for why. Everything
// else (tdrDraw/tdrLeg/tdrText/tdrGrid/tdrCanvas/tdrDiCanvas/cmsPrel/
// cmsPrelim/cmsFinal/countpads) is unmodified.
////////////////////////////////////////////////////////////////////////////////
#ifndef STYLE_H
#define STYLE_H
...
CMS_lumi( TPad* pad, int iPeriod, int iPosX, bool verbose )
{
  ...
  if(iPeriod==15) {
     ...
     // this fork had already half-adapted for a different run period
     // (2023/2024 PbPb, not our pp reference run).
     extraText   = "Internal";
     extraText2  = "";
     extraText3  = "";
  }
