  ...
  for (int ipt = 0; ipt < nPt; ipt++) {
    ...
    for (int ialpha = 0; ialpha < nAlpha; ialpha++) {
      ...
      for (int ieta = 0; ieta < nEta; ieta++) {
        ...
        auto [dlo90, dhi90] = FindTruncBins(hAData, 0.90, controls.minEntries);
        auto [mlo90, mhi90] = FindTruncBins(hAMC, 0.90, controls.minEntries);
        auto [dlo95, dhi95] = FindTruncBins(hAData, 0.95, controls.minEntries);
        auto [mlo95, mhi95] = FindTruncBins(hAMC, 0.95, controls.minEntries);
